...
The form is defined for the case where the total is a real quantity the reader cares about, "these parts are all of it" is part of the assertion, and there are few enough parts to label. Roughly five is the conventional ceiling and it is `authority-asserted`, not measured.

The **donut** frees the center for a total, a label, or an icon, and it costs nothing: the missing angle is the cue that was carrying the least.
...
| There are fifteen parts | [Treemap](treemap.md), or a bar chart without the whole-constraint |
...
Cleveland & McGill, usually cited as the source of the angle claim, wrote:
...
So bars beat pies, measured. The reason universally given for it is not established.
...
The conclusion that bars beat pies for value extraction survives. The mechanism everyone gives for it does not.
