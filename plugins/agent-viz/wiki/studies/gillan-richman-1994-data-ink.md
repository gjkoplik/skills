...
Without the body, the sample sizes, effect sizes, stimuli and per-experiment designs are unknown. No specific numbers can be attributed to this paper.

## The abstract, verbatim

Reproduced in full because it is the only primary text available.
...
**Experiment 1 is a point in Tufte's favor.** At the aggregate level, higher data-ink ratio produced faster responses and greater accuracy across comparison, difference and mean questions on bar and line graphs. That is the rule working.
...
The abstract's own statement of the pattern:
...
So the honest reading is not "the data-ink ratio is wrong." It is: **the aggregate direction is Tufte's, and the element-level decomposition is not.** Erasing ink helps on average and hurts specifically for the elements that carry orientation. [refutations.md](../refutations.md) already lands on the phrasing "strip decoration, keep orientation," and Experiment 1 supports the rule before Experiments 2 and 3 qualify it.

"Pictorial backgrounds generally increased response time and decreased accuracy" is also a result *against* embellishment, from 1994, sixteen years before [Bateman et al.](bateman-2010-useful-junk.md). The two are not in direct conflict, since Bateman measured verbal description and recall on integrated Holmes imagery rather than backgrounds behind a plot, and found no accuracy penalty. The chartjunk record is not one-sided in the pro-embellishment direction.

## What the fourth experiment tested

Unknown. The abstract accounts for Experiments 1, 2 and 3 and does not describe the fourth.
